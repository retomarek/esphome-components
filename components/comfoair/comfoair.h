...
public:
  ...
  void set_fans_intake_only(void) {
    uint8_t command_levels [9] = {(uint8_t) 0x18,(uint8_t) 0x2B, (uint8_t) 0x43, (uint8_t) 0x1A, (uint8_t) 0x2E, (uint8_t) 0x4A, (uint8_t) 0x5B, (uint8_t) 0x64, (uint8_t) 0x00};
    command_levels[0] = (uint8_t) 0x00;
    command_levels[1] = (uint8_t) 0x00;
    command_levels[2] = (uint8_t) 0x00;
    command_levels[6] = (uint8_t) 0x00;
    write_command_(CMD_SET_VENTILATION_LEVEL, command_levels, sizeof(command_levels));

	}

  void set_fans_exhaust_only(void) {
    uint8_t command_levels [9] = {(uint8_t) 0x18,(uint8_t) 0x2B, (uint8_t) 0x43, (uint8_t) 0x1A, (uint8_t) 0x2E, (uint8_t) 0x4A, (uint8_t) 0x5B, (uint8_t) 0x64, (uint8_t) 0x00};
    command_levels[3] = (uint8_t) 0x00;
    command_levels[4] = (uint8_t) 0x00;
    command_levels[5] = (uint8_t) 0x00;
    command_levels[7] = (uint8_t) 0x00;
    write_command_(CMD_SET_VENTILATION_LEVEL, command_levels, sizeof(command_levels));
	}

  void set_fans_intake_and_exhaust(void) {
    uint8_t command_levels [9] = {(uint8_t) 0x18,(uint8_t) 0x2B, (uint8_t) 0x43, (uint8_t) 0x1A, (uint8_t) 0x2E, (uint8_t) 0x4A, (uint8_t) 0x5B, (uint8_t) 0x64, (uint8_t) 0x00};
    write_command_(CMD_SET_VENTILATION_LEVEL, command_levels, sizeof(command_levels));
	}
